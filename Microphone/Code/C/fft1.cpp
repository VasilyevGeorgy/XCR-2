...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    vector<complex<SAMPLE> > fftInput;
    SAMPLE ampl;

    for(i=0;i<numSamples;i++){

        ampl = (data.recordedSamples[i]+1)/2; // -1<=recordedSamples<=1 => 0<=ampl<=1
        values.push_back(ampl);
        //fftInput.push_back(complex<SAMPLE>(i,ampl));  // VIBORKA
    ...
    //std::ostream_iterator<complex<SAMPLE> > output_iterator1(output_file1, "\n");
...
/*    fftw_plan plan = fftw_plan_dft_1d( fftInput.size(), (fftw_complex*) &fftInput[0],
    ...
    //std::ofstream output_file("./spectr.txt");
    //std::ostream_iterator<complex<SAMPLE> > output_iterator(output_file, "\n");
    //std::copy(fftInput.begin(), fftInput.end(), output_iterator);*/

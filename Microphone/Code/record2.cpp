...
bool open(int typeofrecord, int duration){
    ...
    data.maxFrameIndex = duration * SAMPLE_RATE; /* Record for a ... seconds */
    data.frameIndex = 0;
    numSamples = duration * SAMPLE_RATE * NUM_CHANNELS;
...
// Write to file
    ...
    {/////////////////////////////////////////
        ...
        (typeofrecord == 0) ? (fid = fopen(recordname0, "wb")):(fid = fopen(recordname1, "wb"));
